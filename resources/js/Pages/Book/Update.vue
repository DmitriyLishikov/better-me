<template>
    ...
    <form class="flex flex-col w-1/2" method="post" :action="route('books.update', {book: book.id})">
        <input type="hidden" name="_token" :value="csrf">
        <input name="_method" type="hidden" value="PUT">

        <div class="flex flex-col m-2">
            <label>Title</label>
            <input type="text" required name="title" :value="book.title" placeholder="Title...">
        </div>

        <div class="flex flex-col m-2">
            <label>Author</label>
            <input type="text" required name="author" :value="book.author" placeholder="Name...">
        </div>

        <div class="flex flex-col m-2">
            <label>Date</label>
            <input type="text" required name="create_date" :value="book.create_date" placeholder="2022">
        </div>
